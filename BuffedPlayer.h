...
=======
    BuffedPlayer(int row, int col, Map *map, MapItemType type, int currentHP, int maxHP, int atk, int def,  int gold = 0);
    virtual ~BuffedPlayer();
    virtual void takePotion(const PotionType potion);
>>>>>>> Stashed changes
